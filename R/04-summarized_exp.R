...
################################################################################
# Ejercicio: Explica que sucede en las siguientes lineas de comandos

## Comando 1
rse[1:2, ]
# Solo muestra las primeras dos filas:
# gene_1, gene_2

## Comando 2
rse[, c("A", "D", "F")]
# Solo muestra aquellas filas que tuvieron el tratamiento: A, D y F
...
## También se puede ocupar iSEE en este objeto
iSEE::iSEE(sce_layer)
